...
<div class='background_wrapper'>
    <div class='section'><a class='back' href="/work/7">⬅︎</a>掲示板（難易度：★★★☆☆）</div>
        <div class='ul-align-center'>
            <ul class='lg_works'>
                <div class='work_block'>
                    ...
                    <li class='sm_work'>
                    下記のpdf教材を参考に「掲示板」を作成してください。
                    </li>
                    <p class='attention'><a href="{{ asset('storage/BBS_PHP.pdf') }}" download="BBS_PHP.pdf">BBS_PHP.pdf</a></p>
                </div>
            </ul>
            <!-- <ul class='lg_works'>
                <div class='work_block'>
